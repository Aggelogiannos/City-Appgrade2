...
import {legalButtonStyles, legalHeadingStyles} from './Legal';
import Button from "@mui/material/Button";
import ArrowBackIcon from '@mui/icons-material/ArrowBack';
import {useNavigate} from "react-router";
import ArrowTopIcon from "@mui/icons-material/ArrowUpward";
...
export function Terms() {
  ...
  return <React.Fragment>
    <Container className="terms-page">
      {/* Go back to legals page button */}
      <Button size="medium" variant="contained" startIcon={<ArrowBackIcon/>} style={legalButtonStyles}
              onClick={() => navigate("/legal")}>ΠΙΣΩ ΣΤΗΝ ΚΥΡΙΑ ΣΕΛΙΔΑ</Button>
      {/* Main Text */}
      <h1 style={legalHeadingStyles}>Terms and Conditions (στα Αγγλικά)</h1>
      ...
      <ul>
        <li>
          <p><strong>Application</strong> means the software program provided by the Company downloaded by You on any
            electronic device, named MOT Trees</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the
            Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Municipality
            of Thessaloniki, Leof. Vasileos Georgiou 1, Thessaloniki 546 36.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to MOT Trees, accessible from <a
            href="https://adoptatree.york.citycollege.eu/"
            rel="external nofollow noopener">https://adoptatree.york.citycollege.eu/</a></p>
        </li>
        <li>
      ...
      <p>The Service is provided to You &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; and with all faults and defects
        ...
        corrected.</p>
      <p>Without limiting the foregoing, neither the Company nor any of the company's provider makes any representation
      ...
      <p>If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country
        in which you are resident in.</p>
      ...
      <ul>
        <li>By visiting this page on our website: <NavLink to="/contact"></NavLink>
        </li>
      </ul>
      {/* Go to top button */}
      <Box textAlign="right" marginBottom="10px">
        <Button size="medium" variant="contained" startIcon={<ArrowTopIcon/>} style={legalButtonStyles}
                onClick={() => window.scrollTo(0, 0)}>ΠΙΣΩ ΣΤΗΝ ΑΡΧΗ ΤΗΣ ΣΕΛΙΔΑΣ</Button>
      </Box>
    </Container>
  </React.Fragment>
}
